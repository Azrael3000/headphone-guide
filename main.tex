...
Earpad leather cover is made using a thin synthetic leather. It's made of two parts, one rectangular one with dimension 4 x 32 cm and an eliptic one which is of the same size as the wooden ellipse of the pad plus 1 cm inside and 3 cm on the outside. The rectangular patch is sewn on the inside of the ellipse and then it's wrapped over the foam and the wooden pad connector. Don't forget to put on the waschers before glueing the leather to the wood.
